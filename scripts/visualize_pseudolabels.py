...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--pred",
        default="../data/cdw_classify/dataset_seg/pseudolabels/pseudolabels.json",
    ...
    parser.add_argument("--image-id", type=int, default=0, help="Target image id; -1 means random")
...
def main() -> None:
    ...
    print(f"saved: {out_path} | image_id={image_id} | file={file_name} | masks={len(masks)}")
